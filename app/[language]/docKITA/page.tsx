...
import HeroDockita from '@/app/docKITA/components/HeroDockita';
import HowItWorksSection from '@/app/docKITA/components/HowItWorks';
import SolutionShowcase from '@/app/docKITA/components/SolutionShowcase';
import GifTextBlock from '@/app/docKITA/components/GifTextBlock';
import NineGridCards from '@/app/docKITA/components/NineGridCards';
import FaqSection from '@/app/docKITA/components/FAQ';
      ...
      <HeroDockita
        ...
        features={[
          ...
          },
          {
            ...
            description: 'Help organizations maintain and improve data quality and integrity.',
          },
          {
            icon: <ScanEye size={36} className="text-orange-500" />,
            title: 'Data Visualization',
            description: 'Custom dashboards that meaningfully interpret data.',
          },
        ]}
      />
      <HowItWorksSection />
