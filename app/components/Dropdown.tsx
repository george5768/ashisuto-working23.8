  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        ...
        <Link href={"/docKITA"}><DropdownMenuItem>AI Workflow Management System</DropdownMenuItem></Link>
      
        <Link href={"/ai-applications-development"}><DropdownMenuItem>AI Application Customize</DropdownMenuItem></Link>
        <Link href={"/cyber-security"}><DropdownMenuItem>Cybersecurity – Secure Port Assess</DropdownMenuItem></Link>
        
        <DropdownMenuLabel>Services</DropdownMenuLabel>
         <DropdownMenuSeparator></DropdownMenuSeparator>
        <Link href={"/robotics"}><DropdownMenuItem>AI Cobots & AGV Robots</DropdownMenuItem></Link>
        {/* <Link href={"/industrial-design"}><DropdownMenuItem>Industrial Design & UI/UX Design</DropdownMenuItem></Link> */}
        <Link href={"/digitize-records"}><DropdownMenuItem>AI Digitize Past Records & Documents</DropdownMenuItem></Link>
